...
#set_property -dict { PACKAGE_PIN P1    IOSTA#ZNDARD LVCMOS33 } [get_ports {led[14]}]
...
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports {rx}];#Sch name = XA2_P
